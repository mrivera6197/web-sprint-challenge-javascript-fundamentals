...
function getPopulationToal(arr){
  const populationTotal = arr.reduce(function(acc, item){
...
console.log(getPopulationToal(zooAnimals));
...
// console.log(consume('Mali', 'Rivera', greeting));
